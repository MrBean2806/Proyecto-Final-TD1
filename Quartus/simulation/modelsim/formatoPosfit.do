...
add wave -noupdate -label Fila /Top_tb/fila
...
add wave -noupdate -label Motores -expand /Top_tb/Motores
add wave -noupdate -label Estado /Top_tb/estado
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {186033 ps} 0}
...
update
WaveRestoreZoom {0 ps} {999486 ps}
